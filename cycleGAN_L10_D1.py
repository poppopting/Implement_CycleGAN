...
pickle.dump(losses, open('losses/losses_L{0}_D{1}.pkl'.format(LAMBDA, D_RATIO), 'wb'))


# In[18]:


torch.save(G_A2B, 'models/G_A2B_L{0}_D{1}.pkl'.format(LAMBDA, D_RATIO))
torch.save(G_B2A, 'models/G_B2A_L{0}_D{1}.pkl'.format(LAMBDA, D_RATIO))
